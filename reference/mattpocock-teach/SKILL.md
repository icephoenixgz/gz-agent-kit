...
\- \`MISSION.md\`: A document capturing the \_reason\_ the user is interested in the topic. This should be used to ground all teaching. Use the format in \[MISSION-FORMAT.md\](./MISSION-FORMAT.md).
