---
name: paper-lookup
description: Search 12 academic literature APIs for papers, preprints, citations, open-access full text, Chinese academic papers, and research datasets. Covers PubMed, PMC (full text), bioRxiv, medRxiv, arXiv, OpenAlex, Crossref, Semantic Scholar, CORE, Unpaywall, 中文学术站点 (CNKI/万方/维普/百度学术), Zenodo. Use when searching for papers, citations, DOI/PMID/arXiv lookups, abstracts, full text, open-access PDFs, preprints, citation graphs, author publications, Chinese academic literature, research datasets, or any scholarly literature query. Triggers on mentions of any supported database or requests like "find papers on X", "look up this DOI", "who cites this paper", "get me the PDF", or "搜一下中文论文".
...
| **Chinese academic papers** | **site: 过滤搜索** | **OpenAlex (language:zh)** |
| **Research datasets** | **Zenodo** | — |
| **中国作者/中文学术动态** | **中文学术站点 (CNKI/万方/维普)** | **OpenAlex** |
...
| Comprehensive literature search | PubMed + OpenAlex + Semantic Scholar + 中文学术站点 |
...
| **中英双语学术调研** | **Semantic Scholar/OpenAlex (英文) + site:过滤 (中文) 双路并行** |
| **研究数据集查询** | **Zenodo** |
| **中国同行研究动态** | **中文学术站点 + OpenAlex (language:zh)** |
| **SCI 写作文献调研（兼顾国内外）** | **Semantic Scholar + 中文学术站点 + Zenodo** |
...
### Chinese Academic & Research Data
| Database | Reference File | What it covers |
|---|---|---|
| 中文学术站点 | `references/chinese-academic.md` | CNKI/万方/维普/百度学术中文论文（免费，site:过滤）|
| Zenodo | `references/zenodo.md` | 研究数据集（百万级，全学科，CERN运营）|
</content>
</invoke>
